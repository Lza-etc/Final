      ...
      <Container className="login-main mt-5">
        <Row>
          <Col lg={4} md={6} sm={12} className="text-center m-auto p-5">
            ...
            {login==2 && <Alert className='loginalert' key='danger' variant="danger" >
            Error! Invalid username or password.
            </Alert>}
            <Form>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Control type="username"onChange={onChangeUserName} placeholder="Enter username" />
              </Form.Group>
              ...
              <div className="d-grid gap-2">
                <Button variant="primary" size="lg" onClick={handleLogin} type="submit">
                  Login
                </Button>
              </div>
