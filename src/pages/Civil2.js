...
function Civil2() {
  ...
  const floorData = ["https://raw.githubusercontent.com/Lza-etc/imageData/main/ce2_0.png", "https://raw.githubusercontent.com/Lza-etc/imageData/main/ce2_1.png"];
  const [currentImage, setCurrentImage] = useState("https://raw.githubusercontent.com/Lza-etc/imageData/main/ce2_0.png");
  ...
  useEffect(() => {
    if(dept!=="ce2"){
      sessionStorage.setItem("dept","ce2");
    }
    if (cancel) {
      setP1([])
      setP2([])
  ...
  const fetchData = async () => {
    ...
    if (!data) {
      ...
      await axios.get("http://127.0.0.1:5000/floors/ce2").then(res=>{
        console.log(res)
        setData(res);
    })
        .catch(error => {
